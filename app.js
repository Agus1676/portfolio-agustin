...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typingCode) {
        ...
        const lines = [
            ...
            '  <span class="key">"focus"</span><span style="color:#94a3b8">:</span> <span class="val">"Web &amp; Mobile Systems"</span><span style="color:#94a3b8">,</span>',
            '  <span class="key">"skills"</span><span style="color:#94a3b8">: [</span>',
            '    <span class="val">"React / Next.js"</span><span style="color:#94a3b8">,</span>',
            '    <span class="val">"React Native / Expo"</span><span style="color:#94a3b8">,</span>',
            '    <span class="val">"FastAPI + Gemini AI"</span><span style="color:#94a3b8">,</span>',
            '    <span class="val">"Java + Spring Boot"</span>',
            '  <span style="color:#94a3b8">],</span>',
